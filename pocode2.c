...
void draw() {
    ...
    // (adjusted for Nano 33 BLE Sense axes)
    // ===============================
    rotateX(radians(-pitch));   // invert pitch to match motion
    rotateZ(radians(roll));     // roll mapped to Z
    rotateY(radians(yaw));      // yaw mapped to Y
